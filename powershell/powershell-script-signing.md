...
Let’s now configure PowerShell script signing by doing the following:

1. [Configure the Certificate Templates](#templates)
2. [Enroll for a Signing Certificate](#enrollment)
3. [Configure the Group Policy Objects](#gpos)
4. [Sign a Script and Test](#signing)
